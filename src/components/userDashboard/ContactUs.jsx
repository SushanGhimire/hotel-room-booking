      ...
      <div className="flex flex-col gap-y-4 pb-5 border-b-2 border-green-200">
        ...
        <div className="text-gray-500 flex flex-col gap-y-2">
          <p className="flex gap-x-2">
            <PhoneIcon></PhoneIcon>98459292
          </p>
          <p className="flex gap-x-2">
            <GmailIcon></GmailIcon>something@gmail.com
          </p>
          <p className="flex gap-x-2">
            <FacebookIcon></FacebookIcon>facebook.com/something
          </p>
        </div>
      </div>
      <div className="flex flex-col gap-y-5 mt-10">
        ...
        <form onSubmit={submitHandler} className="flex flex-col gap-y-3">
          ...
          <textarea
            id=""
            name="complain"
            value={inquiry.complain}
            cols="30"
            rows="10"
            placeholder="Text Here..."
            onChange={changeHandler}
          ></textarea>
          <button className="px-5 py-2 bg-buttonBlue text-white w-2/12 rounded-md hover:bg-primaryBlue transition-all duration-300">
            Submit
          </button>
        </form>
        <p className="text-primaryBlue pb-3 w-full">
          Note: It may take couple of hours or days to reply your inquiry, we
          hope our valuable customers to be patient
        </p>
      </div>
    </div>
  );
