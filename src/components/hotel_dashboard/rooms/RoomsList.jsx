                  ...
                  roomList.map((room, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-sm">{room_code}</td>
                        <td className="px-4 py-3 text-sm">Rs {price}</td>
                        <td className="px-4 py-3 text-xs">
                          {status === "DF" ? (
                            <span className="px-2 py-1 font-semibold leading-tight text-red-700 bg-red-100 rounded-full dark:bg-green-700 dark:text-green-100">
                              Draft
                            </span>
                          ) : (
